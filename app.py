...
st.sidebar.markdown("Customise the analysis below.")
...
st.sidebar.markdown(
    ...
    "**Data:** [Spotify Global Streaming Data 2024](https://www.kaggle.com/datasets/"
...
st.markdown(
    f"**A data-driven tool for record label A&R teams** — compare genre commercial performance, "
    f"artist market structure, monetisation potential and regional trends across "
    f"**{len(selected_countries)} countries** and **{len(selected_genres)} genres**."
)
...
# ══════════════════════════════════════════════════════════════════════════════
st.markdown("---")
st.subheader("📌 Snapshot: Selected Genres")
...
| Strategy | Genre | Why |
|----------|-------|-----|
| **Subscription revenue** | Rock 🎸 | Highest premium conversion — listeners willing to pay |
| **Engagement & catalogue** | R&B 💿 | Highest streams, lowest skip rate, best replay value |
| **Emerging niche** | Jazz 🎷 | Loyal premium audience, strong in non-traditional markets |
| **Mass reach** | Pop 🎤 | Widest audience but highest skip rate — use as traffic driver |

> **Bottom line:** A dual-track strategy investing in **Rock** (subscription revenue) and **R&B** (engagement value) offers the best risk-adjusted return for a record label's portfolio.
""")

st.markdown("---")
st.caption(
    "Data: Kaggle — Spotify Global Streaming Data 2024 · "
    "Course: ACC102 Mini Assignment · Track 4 · "
