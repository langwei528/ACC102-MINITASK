...
/* only mute paragraph text that's NOT inside custom HTML cards */
[data-testid="stMarkdownContainer"] > p { color: #888880 !important; }
[data-testid="stMarkdownContainer"] li { color: #888880 !important; }
