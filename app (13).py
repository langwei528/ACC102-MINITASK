...
[data-testid="stMarkdownContainer"] > p { color: #B8B2E8 !important; }
[data-testid="stMarkdownContainer"] li  { color: #B8B2E8 !important; }
...
for i, genre in enumerate(selected_genres):
    ...
    with cols[i]:
        ...
        st.caption(
            f"👥 {sub[LISTENER_COL].mean():.1f}M listeners  |  💳 {prem_pct:.0f}% Premium  |  ⏱️ {sub[DURATION_COL].mean():.2f} min avg"
        )
